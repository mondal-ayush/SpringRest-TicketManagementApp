...
import in.ayush.dao.ITouristRepo;
import in.ayush.exception.TouristNotFoundException;
...
public class TouristMgmtServiceImpl implements ITouristMgmtService {
	...
	public String updateTouristByDetails(Tourist tourist) {
		...
		if (optional.isPresent()) {
			repo.save(tourist); // save() performs both insert and update depending on presence of id value
